# Django settings for arsoapi project.
import os
...
DATABASES = {
	...
	#'NAME': 'arsoapi',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '*18w#7jp-+(4zkrq_tzd&!#aw!p+s9ud99c((g7$lj=nb54ej='
